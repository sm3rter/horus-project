...
class CourseUpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'cheating_students' => 'required|integer',
            'misconduct_students' => 'required|integer',
            ...
            'withdraw_students' => 'required|integer|min:0',
            'total_absent_students' => 'required|integer|min:0',
            'total_present_students' => 'required|integer|min:0',
            'total_deprived_students' => 'required|integer|min:0',
            'incomplete_students' => 'required|integer|min:0',
